...
Path: String;
begin
      LoadStringFromFile(ExpandConstant('{%ProgramData}\Autodesk\Revit\Addins\2018\basic_bim_checker.addin'), C);
      CU := C;
      Path := ExpandConstant('{app}')
      StringChangeEx(CU, 'path', Path, True);
      C := CU;
      SaveStringToFile(ExpandConstant('{%ProgramData}\Autodesk\Revit\Addins\2018\basic_bim_checker.addin'), C, False);
end;
