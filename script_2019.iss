...
AppId={{277D58CB-ACDA-41E1-8331-81490653CA65}
AppName={#MyAppName}
...
DefaultDirName={pf}\Basic_BIM_Checker_2019
DefaultGroupName=Basic_BIM_Checker_2019
OutputBaseFilename=Basic_BIM_Checker_installer_REVIT_2019
Compression=lzma
...
; Addin file
Source: "U:\01_python_revit_documentatie\00_python_scripts\01_basic_bim_checker\basic_bim_checker.addin"; DestDir: "{%ProgramData}\Autodesk\Revit\Addins\2019"; Flags: ignoreversion
...
Path: String;
begin
      LoadStringFromFile(ExpandConstant('{%ProgramData}\Autodesk\Revit\Addins\2019\basic_bim_checker.addin'), C);
      CU := C;
      Path := ExpandConstant('{app}')
      StringChangeEx(CU, 'path', Path, True);
      C := CU;
      SaveStringToFile(ExpandConstant('{%ProgramData}\Autodesk\Revit\Addins\2019\basic_bim_checker.addin'), C, False);
end;
